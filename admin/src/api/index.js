 ...
 * 项目
 */
export function findAllCompetition () { // 项目列表
    return axios.post('along/CrossCompetitionController/findAllCompetition')
}
export function findEntity (competitionId) { // 项目下面的科目
 ...
 * 设备绑定
 */
// export function findListJoinCardByCompetition(competitionId){//获取项目下所有人员信息，以及绑定的指卡
...
export function findAllGpsList () { // 项目列表
    return axios.post('along/CrossGpsController/findAllGpsList')
}

export function updateEntityAndGps (sportsmanList, competitionId, competitionItemId) { // 项目列表
    return axios({
        method: 'post',
 ...
 * 项目
 */
export function findAllGetPage (name, pageNumber, length) { // 项目列表，分页
    return axios({
        method: 'post',
...
export function saveEntity (id, name, startDate, location, isPublish) { // 新增项目
    return axios({
        method: 'post',
...
export function gameitemdelEntity (competitionItemId) { // 删除科目
...
export function findItemGroupList (competitionId, competitionItemId) { // 获取项目科目关系数据组别
    return axios({
        method: 'post',
...
export function bindsaveEntity (competitionId, competitionItemId, params) { // 绑定项目科目关系数据组别
    return axios({
        method: 'post',
        url: 'along/CrossCompetitionItemGroupController/saveEntity',
        data: JSON.stringify({
            competitionId: competitionId, // 项目id
            competitionItemId: competitionItemId, // 科目id
...
export function fingerupdateEntity (competitionId, params) { // 配置项目科目关系数据组别
    return axios({
        method: 'post',
