<template>
    <div class="game">
        <div class="game_head">
            <a-input v-model="searchInfo" @pressEnter = "search" placeholder="请输入项目名称"/>
        ...
        <a-modal
            ...
            >
            <div class="game_name">
                项目名称：<a-input v-model="gamename" placeholder="请输入项目名称"/>
            </div>
            <div class="game_time">
                举办时间：<a-date-picker
            ...
            <div class="game_local">
                举办地点：<a-input v-model="gamelocation" placeholder="请输入项目地点"/>
            </div>
            <div class="game_local">
...
export default {
    ...
    methods: {
        moment,
        edit (id, name, date, location, isfb) { // 编辑项目
            this.gameid = id
            this.gamename = name
