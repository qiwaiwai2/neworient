    ...
    <div class="drawLoats">
        <a-spin :spinning="spinning" :tip="loadingText">
            ...
            <div class="drawLoats_cont">
                ...
                <div class="table">
                    <div class="yfp"  v-show="operate_type==1">
                        <div class="yfphead">
                            <a-input @pressEnter="search" v-model="searchInfo" placeholder="请输入卫星编号"/>
            ...
            <a-modal
                ...
                <div class="game_name">
                    <span class="modal_title">卫星 ID：</span><a-input v-model="gpsNO" placeholder="请输入卫星 ID"/>
                </div>
            </a-modal>
        </a-spin>
    </div>
    ...
    methods: {
        ...
        async operate () {
            ...
            if (this.selectedMan.length > this.gpsNum) {
                this.spinning = false
                alert('剩余' + this.gpsNum + '个卫星，您的选择已超出！')
            } else {
